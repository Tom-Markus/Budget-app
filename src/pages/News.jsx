      ...
      [
        {
          ...
          items: [
            ...
            { label: 'Pétrole (WTI)',   prix: fmtS(markets?.oil?.price,   2), unite: '$/b', change: markets?.oil?.change   ?? null, coinId: null, indexSymbol: 'CL=F' },
            { label: 'Pétrole (Brent)', prix: fmtS(markets?.brent?.price, 2), unite: '$/b', change: markets?.brent?.change ?? null, coinId: null, indexSymbol: 'BZ=F' },
          ],
        },
        {
