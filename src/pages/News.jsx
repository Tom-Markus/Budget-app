...
import {
  ...
  LineChart as LineChartIcon, CandlestickChart,
} from 'lucide-react'
import {
...
// ── Bougie custom pour Recharts ComposedChart ─────────────────────────────────
...
function GrapheModal({ item, onClose }) {
  ...
  // Reset mode + ohlc quand l'actif change
  useEffect(() => {
    setChartMode('line')
    setOhlcData(null)
    setOhlcError(false)
  ...
  // Fetch données OHLC au premier passage en mode bougie
